...
if (isset($_GET["edit_post_id"]) && !empty($_GET["edit_post_id"])) {
    ...
    $sql_post = "SELECT * FROM posts WHERE id = '$post_edit_id'";
    $query_post = mysqli_query($connection, $sql_post);
    while ($result = mysqli_fetch_assoc($query_post)) {
        $post_thumbnail = $result["thumbnail"];
        $post_title = $result["title"];
        $post_content = $result["content"];
        $post_category_id = $result["category_id"];
                        ...
                        <div class="container p-4 pl-4 pr-4">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" value="<?php echo $post_title ?>" placeholder="Enter blog title">
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" class="form-control" id="">
                                                ...
                                                ?>
                                                    <option value="<?php echo $result["id"] ?>" <?php echo $post_category_id == $result["id"] ? "selected" : "" ?>><?php echo $result["name"] ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="" class="form-control" cols="30" placeholder="Enter blog content" rows="10">
